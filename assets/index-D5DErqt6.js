 ...
 */const It=globalThis,be=It.ShadowRoot&&(It.ShadyCSS===void 0||It.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,me=Symbol(),De=new WeakMap;let hr=class{constructor(t,r,o){if(this._$cssResult$=!0,o!==me)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o;const r=this.t;if(be&&t===void 0){const o=r!==void 0&&r.length===1;o&&(t=De.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),o&&De.set(r,t))}return t}toString(){return this.cssText}};const Hr=e=>new hr(typeof e=="string"?e:e+"",void 0,me),x=(e,...t)=>{const r=e.length===1?e[0]:t.reduce((o,i,n)=>o+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+e[n+1],e[0]);return new hr(r,e,me)},Wr=(e,t)=>{if(be)e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(const r of t){const o=document.createElement("style"),i=It.litNonce;i!==void 0&&o.setAttribute("nonce",i),o.textContent=r.cssText,e.appendChild(o)}},Te=be?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(const o of t.cssRules)r+=o.cssText;return Hr(r)})(e):e;/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bo=(e,t,r)=>(r.configurable=!0,r.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,r),r);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function K(e,t){return(r,o,i)=>{const n=a=>a.renderRoot?.querySelector(e)??null;return bo(r,o,{get(){return n(this)}})}}var se="";function le(e){se=e}function mo(e=""){if(!se){const t=[...document.getElementsByTagName("script")],r=t.find(o=>o.hasAttribute("data-shoelace"));if(r)le(r.getAttribute("data-shoelace"));else{const o=t.find(n=>/shoelace(\.min)?\.js($|\?)/.test(n.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(n.src));let i="";o&&(i=o.getAttribute("src")),le(i.split("/").slice(0,-1).join("/"))}}return se.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var go={name:"default",resolver:e=>mo(`assets/icons/${e}.svg`)},vo=go,je={caret:`
...
//# sourceMappingURL=index-D5DErqt6.js.map
