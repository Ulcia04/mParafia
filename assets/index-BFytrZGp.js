const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/app-about-BiAN1IRD.js","assets/chunk.3LWOA5DF-xa6AWMhW.js"])))=>i.map(i=>d[i]);
import{setBasePath as gt}from"https://cdn.jsdelivr.net/npm/@shoelace-style/shoelace@2.16.0/dist/utilities/base-path.js";import{n as c,b as f,i as _,c as D,S as N,_ as at,a as B,d as l,A as mt,H as vt,e as wt,s as yt,f as T,t as j}from"./chunk.3LWOA5DF-xa6AWMhW.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function o(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(a){if(a.ep)return;a.ep=!0;const n=o(a);fetch(a.href,n)}})();gt("https://cdn.jsdelivr.net/npm/@shoelace-style/shoelace@2.16.0/cdn/");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function q(e){return c({...e,state:!0,attribute:!1})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,O="";function X(e){O=e}function Ot(e=""){if(!O){const t=[...document.getElementsByTagName("script")],o=t.find(r=>r.hasAttribute("data-shoelace"));if(o)X(o.getAttribute("data-shoelace"));else{const r=t.find(n=>/shoelace(\.min)?\.js($|\?)/.test(n.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(n.src));let a="";r&&(a=r.getAttribute("src")),X(a.split("/").slice(0,-1).join("/"))}}return O.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var It={name:"default",resolver:e=>Ot(`assets/icons/${e}.svg`)},Ft=It,tt={caret:`
  ...
  `},Dt={name:"system",resolver:e=>e in tt?`data:image/svg+xml,${encodeURIComponent(tt[e])}`:""},Nt=Dt,Tt=[Ft,Nt],I=[];function jt(e){I.push(e)}function qt(e){I=I.filter(t=>t!==e)}function et(e){return Tt.find(t=>t.name===e)}var Wt=_`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`;function G(e,t){const o=B({waitUntilFirstUpdate:!1},t);return(r,a)=>{const{update:n}=r,s=Array.isArray(e)?e:[e];r.update=function(i){s.forEach(d=>{const h=d;if(i.has(h)){const v=i.get(h),b=this[h];v!==b&&(!o.waitUntilFirstUpdate||this.hasUpdated)&&this[a](v,b)}}),n.call(this,i)}}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ht=(e,t)=>e?._$litType$!==void 0;var $=Symbol(),E=Symbol(),V,R=new Map,g=class extends N{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var o;let r;if(t?.spriteSheet)return this.svg=f`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(r=await fetch(e,{mode:"cors"}),!r.ok)return r.status===410?$:E}catch{return E}try{const a=document.createElement("div");a.innerHTML=await r.text();const n=a.firstElementChild;if(((o=n?.tagName)==null?void 0:o.toLowerCase())!=="svg")return $;V||(V=new DOMParser);const i=V.parseFromString(n.outerHTML,"text/html").body.querySelector("svg");return i?(i.part.add("svg"),document.adoptNode(i)):$}catch{return $}}connectedCallback(){super.connectedCallback(),jt(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),qt(this)}getIconSource(){const e=et(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const{url:t,fromLibrary:o}=this.getIconSource(),r=o?et(this.library):void 0;if(!t){this.svg=null;return}let a=R.get(t);if(a||(a=this.resolveIcon(t,r),R.set(t,a)),!this.initialRender)return;const n=await a;if(n===E&&R.delete(t),t===this.getIconSource().url){if(Ht(n)){if(this.svg=n,r){await this.updateComplete;const s=this.shadowRoot.querySelector("[part='svg']");typeof r.mutator=="function"&&s&&r.mutator(s)}return}switch(n){case E:case $:this.svg=null,this.emit("sl-error");break;default:this.svg=n.cloneNode(!0),(e=r?.mutator)==null||e.call(r,this.svg),this.emit("sl-load")}}}render(){return this.svg}};g.styles=[D,Wt];l([q()],g.prototype,"svg",2);l([c({reflect:!0})],g.prototype,"name",2);l([c()],g.prototype,"src",2);l([c()],g.prototype,"label",2);l([c({reflect:!0})],g.prototype,"library",2);l([G("label")],g.prototype,"handleLabelChange",1);l([G(["name","src","library"])],g.prototype,"setIcon",1);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ht=Symbol.for(""),Kt=e=>{if(e?.r===ht)return e?._$litStatic$},ot=(e,...t)=>({_$litStatic$:t.reduce((o,r,a)=>o+(n=>{if(n._$litStatic$!==void 0)return n._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${n}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(r)+e[a+1],e[0]),r:ht}),rt=new Map,Zt=e=>(t,...o)=>{const r=o.length;let a,n;const s=[],i=[];let d,h=0,v=!1;for(;h<r;){for(d=t[h];h<r&&(n=o[h],(a=Kt(n))!==void 0);)d+=a+t[++h],v=!0;h!==r&&i.push(n),s.push(d),h++}if(h===r&&s.push(t[r]),v){const b=s.join("$$lit$$");(t=rt.get(b))===void 0&&(s.raw=s,rt.set(b,t=s)),o=i}return e(t,...o)},U=Zt(f);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const p=e=>e??mt;var u=class extends N{constructor(){super(...arguments),this.formControlController=new Ut(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new vt(this,"[default]","prefix","suffix"),this.localize=new ut(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Z}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink(),t=e?ot`a`:ot`button`;return U`
      <${t}
        part="base"
    ...
    `}};u.styles=[D,Mt];u.dependencies={"sl-icon":g,"sl-spinner":dt};l([xt(".button")],u.prototype,"button",2);l([q()],u.prototype,"hasFocus",2);l([q()],u.prototype,"invalid",2);l([c()],u.prototype,"title",2);l([c({reflect:!0})],u.prototype,"variant",2);l([c({reflect:!0})],u.prototype,"size",2);l([c({type:Boolean,reflect:!0})],u.prototype,"caret",2);l([c({type:Boolean,reflect:!0})],u.prototype,"disabled",2);l([c({type:Boolean,reflect:!0})],u.prototype,"loading",2);l([c({type:Boolean,reflect:!0})],u.prototype,"outline",2);l([c({type:Boolean,reflect:!0})],u.prototype,"pill",2);l([c({type:Boolean,reflect:!0})],u.prototype,"circle",2);l([c()],u.prototype,"type",2);l([c()],u.prototype,"name",2);l([c()],u.prototype,"value",2);l([c()],u.prototype,"href",2);l([c()],u.prototype,"target",2);l([c()],u.prototype,"rel",2);l([c()],u.prototype,"download",2);l([c()],u.prototype,"form",2);l([c({attribute:"formaction"})],u.prototype,"formAction",2);l([c({attribute:"formenctype"})],u.prototype,"formEnctype",2);l([c({attribute:"formmethod"})],u.prototype,"formMethod",2);l([c({attribute:"formnovalidate",type:Boolean})],u.prototype,"formNoValidate",2);l([c({attribute:"formtarget"})],u.prototype,"formTarget",2);l([G("disabled",{waitUntilFirstUpdate:!0})],u.prototype,"handleDisabledChange",1);u.define("sl-button");var Gt=Object.defineProperty,Yt=Object.getOwnPropertyDescriptor,bt=(e,t,o,r)=>{for(var a=r>1?void 0:r?Yt(t,o):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(a=(r?s(t,o,a):s(a))||a);return r&&a&&Gt(t,o,a),a};let z=class extends T{constructor(){super(...arguments),this.message="Welcome!"}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"PWABuilder pwa-starter",text:"Check out the PWABuilder pwa-starter!",url:"https://github.com/pwa-builder/pwa-starter"})}render(){return f`
  ...
  `];bt([c()],z.prototype,"message",2);z=bt([j("app-home")],z);var Jt=Object.defineProperty,Qt=Object.getOwnPropertyDescriptor,Y=(e,t,o,r)=>{for(var a=r>1?void 0:r?Qt(t,o):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(a=(r?s(t,o,a):s(a))||a);return r&&a&&Jt(t,o,a),a};let L=class extends T{constructor(){super(...arguments),this.title="PWA Starter",this.enableBack=!1}render(){return f`
      <header>
  ...
  `;Y([c({type:String})],L.prototype,"title",2);Y([c({type:Boolean})],L.prototype,"enableBack",2);L=Y([j("app-header")],L);var Xt=Object.getOwnPropertyDescriptor,te=(e,t,o,r)=>{for(var a=r>1?void 0:r?Xt(t,o):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(a=s(a)||a);return a};let F=class extends T{firstUpdated(){Q.addEventListener("route-changed",()=>{"startViewTransition"in document?document.startViewTransition(()=>this.requestUpdate()):this.requestUpdate()})}render(){return Q.render()}};F.styles=_`
    main {
      padding-left: 16px;
      padding-right: 16px;
      padding-bottom: 16px;
  ...
  `;F=te([j("app-index")],F);
//# sourceMappingURL=index-BFytrZGp.js.map
