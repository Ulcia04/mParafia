 ...
 */const kr=Symbol.for(""),ti=e=>{if(e?.r===kr)return e?._$litStatic$},qt=(e,...t)=>({_$litStatic$:t.reduce((r,o,i)=>r+(a=>{if(a._$litStatic$!==void 0)return a._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${a}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(o)+e[i+1],e[0]),r:kr}),Ze=new Map,ei=e=>(t,...r)=>{const o=r.length;let i,a;const n=[],s=[];let l,d=0,u=!1;for(;d<o;){for(l=t[d];d<o&&(a=r[d],(i=ti(a))!==void 0);)l+=i+t[++d],u=!0;d!==o&&s.push(a),n.push(l),d++}if(d===o&&n.push(t[o]),u){const c=n.join("$$lit$$");(t=Ze.get(c))===void 0&&(n.raw=n,Ze.set(c,t=n)),r=s}return e(t,...r)},Vt=ei(g);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const w=e=>e??_;var z=class extends O{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?qt`a`:qt`button`;return Vt`
      <${t}
        part="base"
...
`,te=class extends O{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};te.styles=[Y,ci];h([p({type:Boolean,reflect:!0})],te.prototype,"vertical",2);h([G("vertical")],te.prototype,"handleVerticalChange",1);te.define("sl-divider");function di(e){for(var t=[],r=0;r<e.length;){var o=e[r];if(o==="*"||o==="+"||o==="?"){t.push({type:"MODIFIER",index:r,value:e[r++]});continue}if(o==="\\"){t.push({type:"ESCAPED_CHAR",index:r++,value:e[r++]});continue}if(o==="{"){t.push({type:"OPEN",index:r,value:e[r++]});continue}if(o==="}"){t.push({type:"CLOSE",index:r,value:e[r++]});continue}if(o===":"){for(var i="",a=r+1;a<e.length;){var n=e.charCodeAt(a);if(n>=48&&n<=57||n>=65&&n<=90||n>=97&&n<=122||n===95){i+=e[a++];continue}break}if(!i)throw new TypeError("Missing parameter name at ".concat(r));t.push({type:"NAME",index:r,value:i}),r=a;continue}if(o==="("){var s=1,l="",a=r+1;if(e[a]==="?")throw new TypeError('Pattern cannot start with "?" at '.concat(a));for(;a<e.length;){if(e[a]==="\\"){l+=e[a++]+e[a++];continue}if(e[a]===")"){if(s--,s===0){a++;break}}else if(e[a]==="("&&(s++,e[a+1]!=="?"))throw new TypeError("Capturing groups are not allowed at ".concat(a));l+=e[a++]}if(s)throw new TypeError("Unbalanced pattern at ".concat(r));if(!l)throw new TypeError("Missing pattern at ".concat(r));t.push({type:"PATTERN",index:r,value:l}),r=a;continue}t.push({type:"CHAR",index:r,value:e[r++]})}return t.push({type:"END",index:r,value:""}),t}function Pe(e,t){t===void 0&&(t={});for(var r=di(e),o=t.prefixes,i=o===void 0?"./":o,a=t.delimiter,n=a===void 0?"/#?":a,s=[],l=0,d=0,u="",c=function(S){if(d<r.length&&r[d].type===S)return r[d++].value},m=function(S){var k=c(S);if(k!==void 0)return k;var F=r[d],ee=F.type,Kr=F.index;throw new TypeError("Unexpected ".concat(ee," at ").concat(Kr,", expected ").concat(S))},f=function(){for(var S="",k;k=c("CHAR")||c("ESCAPED_CHAR");)S+=k;return S},b=function(S){for(var k=0,F=n;k<F.length;k++){var ee=F[k];if(S.indexOf(ee)>-1)return!0}return!1},I=function(S){var k=s[s.length-1],F=S||(k&&typeof k=="string"?k:"");if(k&&!F)throw new TypeError('Must have text between two parameters, missing text after "'.concat(k.name,'"'));return!F||b(F)?"[^".concat(B(n),"]+?"):"(?:(?!".concat(B(F),")[^").concat(B(n),"])+?")};d<r.length;){var E=c("CHAR"),A=c("NAME"),st=c("PATTERN");if(A||st){var T=E||"";i.indexOf(T)===-1&&(u+=T,T=""),u&&(s.push(u),u=""),s.push({name:A||l++,prefix:T,suffix:"",pattern:st||I(T),modifier:c("MODIFIER")||""});continue}var y=E||c("ESCAPED_CHAR");if(y){u+=y;continue}u&&(s.push(u),u="");var Z=c("OPEN");if(Z){var T=f(),V=c("NAME")||"",mt=c("PATTERN")||"",lt=f();m("CLOSE"),s.push({name:V||(mt?l++:""),pattern:V&&!mt?I(T):mt,prefix:T,suffix:lt,modifier:c("MODIFIER")||""});continue}m("END")}return s}function Dr(e,t){return Or(Pe(e,t),t)}function Or(e,t){t===void 0&&(t={});var r=De(t),o=t.encode,i=o===void 0?function(l){return l}:o,a=t.validate,n=a===void 0?!0:a,s=e.map(function(l){if(typeof l=="object")return new RegExp("^(?:".concat(l.pattern,")$"),r)});return function(l){for(var d="",u=0;u<e.length;u++){var c=e[u];if(typeof c=="string"){d+=c;continue}var m=l?l[c.name]:void 0,f=c.modifier==="?"||c.modifier==="*",b=c.modifier==="*"||c.modifier==="+";if(Array.isArray(m)){if(!b)throw new TypeError('Expected "'.concat(c.name,'" to not repeat, but got an array'));if(m.length===0){if(f)continue;throw new TypeError('Expected "'.concat(c.name,'" to not be empty'))}for(var I=0;I<m.length;I++){var E=i(m[I],c);if(n&&!s[u].test(E))throw new TypeError('Expected all "'.concat(c.name,'" to match "').concat(c.pattern,'", but got "').concat(E,'"'));d+=c.prefix+E+c.suffix}continue}if(typeof m=="string"||typeof m=="number"){var E=i(String(m),c);if(n&&!s[u].test(E))throw new TypeError('Expected "'.concat(c.name,'" to match "').concat(c.pattern,'", but got "').concat(E,'"'));d+=c.prefix+E+c.suffix;continue}if(!f){var A=b?"an array":"a string";throw new TypeError('Expected "'.concat(c.name,'" to be ').concat(A))}}return d}}function B(e){return e.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}function De(e){return e&&e.sensitive?"":"i"}function ui(e,t){if(!t)return e;for(var r=/\((?:\?<(.*?)>)?(?!\?)/g,o=0,i=r.exec(e.source);i;)t.push({name:i[1]||o++,prefix:"",suffix:"",modifier:"",pattern:""}),i=r.exec(e.source);return e}function hi(e,t,r){var o=e.map(function(i){return Tr(i,t,r).source});return new RegExp("(?:".concat(o.join("|"),")"),De(r))}function pi(e,t,r){return fi(Pe(e,r),t,r)}function fi(e,t,r){r===void 0&&(r={});for(var o=r.strict,i=o===void 0?!1:o,a=r.start,n=a===void 0?!0:a,s=r.end,l=s===void 0?!0:s,d=r.encode,u=d===void 0?function(k){return k}:d,c=r.delimiter,m=c===void 0?"/#?":c,f=r.endsWith,b=f===void 0?"":f,I="[".concat(B(b),"]|$"),E="[".concat(B(m),"]"),A=n?"^":"",st=0,T=e;st<T.length;st++){var y=T[st];if(typeof y=="string")A+=B(u(y));else{var Z=B(u(y.prefix)),V=B(u(y.suffix));if(y.pattern)if(t&&t.push(y),Z||V)if(y.modifier==="+"||y.modifier==="*"){var mt=y.modifier==="*"?"?":"";A+="(?:".concat(Z,"((?:").concat(y.pattern,")(?:").concat(V).concat(Z,"(?:").concat(y.pattern,"))*)").concat(V,")").concat(mt)}else A+="(?:".concat(Z,"(").concat(y.pattern,")").concat(V,")").concat(y.modifier);else{if(y.modifier==="+"||y.modifier==="*")throw new TypeError('Can not repeat "'.concat(y.name,'" without a prefix and suffix'));A+="(".concat(y.pattern,")").concat(y.modifier)}else A+="(?:".concat(Z).concat(V,")").concat(y.modifier)}}if(l)i||(A+="".concat(E,"?")),A+=r.endsWith?"(?=".concat(I,")"):"$";else{var lt=e[e.length-1],S=typeof lt=="string"?E.indexOf(lt[lt.length-1])>-1:lt===void 0;i||(A+="(?:".concat(E,"(?=").concat(I,"))?")),S||(A+="(?=".concat(E,"|").concat(I,")"))}return new RegExp(A,De(r))}function Tr(e,t,r){return e instanceof RegExp?ui(e,t):Array.isArray(e)?hi(e,t,r):pi(e,t,r)}const rt=Symbol("NotFoundResult");class Rr extends Error{code;context;constructor(t){super(W(`Page not found (${t.pathname})`)),this.context=t,this.code=404}}function tt(e){return typeof e=="object"&&!!e}function Dt(e){return typeof e=="function"}function N(e){return typeof e=="string"}function Kt(e=[]){return Array.isArray(e)?e:[e]}function W(e){return`[Vaadin.Router] ${e}`}function Lr(e){return new Rr(e)}function Ur(e){return(Array.isArray(e)?e[0]:e)??""}function Gt(e){return Ur(e?.path)}function mi(e){return Array.isArray(e)&&e.length>0?e:void 0}const fe=new Map;fe.set("|false",{keys:[],pattern:/(?:)/u});function tr(e){try{return decodeURIComponent(e)}catch{return e}}function bi(e,t,r=!1,o=[],i){const a=`${e}|${String(r)}`,n=Ur(t);let s=fe.get(a);if(!s){const u=[];s={keys:u,pattern:Tr(e,u,{end:r,strict:e===""})},fe.set(a,s)}const l=s.pattern.exec(n);if(!l)return null;const d={...i};for(let u=1;u<l.length;u++){const c=s.keys[u-1],m=c.name,f=l[u];(f!==void 0||!Object.prototype.hasOwnProperty.call(d,m))&&(c.modifier==="+"||c.modifier==="*"?d[m]=f?f.split(/[/?#]/u).map(tr):[]:d[m]=f&&tr(f))}return{keys:[...o,...s.keys],params:d,path:l[0]}}var gi=bi;function Mr(e,t,r,o,i){let a,n,s=0,l=Gt(e);return l.startsWith("/")&&(r&&(l=l.substring(1)),r=!0),{next(d){if(e===d)return{done:!0,value:void 0};e.__children??=mi(e.children);const u=e.__children??[],c=!e.__children&&!e.children;if(!a&&(a=gi(l,t,c,o,i),a))return{value:{keys:a.keys,params:a.params,path:a.path,route:e}};if(a&&u.length>0)for(;s<u.length;){if(!n){const f=u[s];f.parent=e;let b=a.path.length;b>0&&t.charAt(b)==="/"&&(b+=1),n=Mr(f,t.substring(b),r,a.keys,a.params)}const m=n.next(d);if(!m.done)return{done:!1,value:m.value};n=null,s+=1}return{done:!0,value:void 0}}}}var vi=Mr;function yi(e){if(Dt(e.route.action))return e.route.action(e)}function wi(e,t){let r=e;for(;r;)if(r=r.parent,r===t)return!0;return!1}function _i(e){return!!e&&typeof e=="object"&&"next"in e&&"params"in e&&"result"in e&&"route"in e}class xi extends Error{cause;code;context;constructor(t,r){let o=`Path '${t.pathname}' is not properly resolved due to an error.`;const i=Gt(t.route);i&&(o+=` Resolution had failed on route: '${i}'`),super(o),this.cause=r?.cause,this.code=r?.code,this.context=t}warn(){console.warn(this.message)}}function ki(e,t){const{path:r,route:o}=t;if(o&&!o.__synthetic){const i={path:r,route:o};if(o.parent&&e.chain)for(let a=e.chain.length-1;a>=0&&e.chain[a].route!==o.parent;a--)e.chain.pop();e.chain?.push(i)}}class $i{baseUrl;#r;errorHandler;resolveRoute;#t;constructor(t,{baseUrl:r="",context:o,errorHandler:i,resolveRoute:a=yi}={}){if(Object(t)!==t)throw new TypeError("Invalid routes");this.baseUrl=r,this.errorHandler=i,this.resolveRoute=a,Array.isArray(t)?this.#t={__children:t,__synthetic:!0,action:()=>{},path:""}:this.#t={...t,parent:void 0},this.#r={...o,hash:"",async next(){return rt},params:{},pathname:"",resolver:this,route:this.#t,search:"",chain:[]}}get root(){return this.#t}get context(){return this.#r}get __effectiveBaseUrl(){return this.baseUrl?new URL(this.baseUrl,document.baseURI||document.URL).href.replace(/[^/]*$/u,""):""}getRoutes(){return[...this.#t.__children??[]]}removeRoutes(){this.#t.__children=[]}async resolve(t){const r=this,o={...this.#r,...N(t)?{pathname:t}:t,next:d},i=vi(this.#t,this.__normalizePathname(o.pathname)??o.pathname,!!this.baseUrl),a=this.resolveRoute;let n=null,s=null,l=o;async function d(u=!1,c=n?.value?.route,m){const f=m===null?n?.value?.route:void 0;if(n=s??i.next(f),s=null,!u&&(n.done||!wi(n.value.route,c)))return s=n,rt;if(n.done)throw Lr(o);l={...o,params:n.value.params,route:n.value.route,chain:l.chain?.slice()},ki(l,n.value);const b=await a(l);return b!=null&&b!==rt?(l.result=_i(b)?b.result:b,r.#r=l,l):await d(u,c,b)}try{return await d(!0,this.#t)}catch(u){const c=u instanceof Rr?u:new xi(l,{code:500,cause:u});if(this.errorHandler)return l.result=this.errorHandler(c),l;throw u}}setRoutes(t){return this.#t.__children=[...Kt(t)],{}}__normalizePathname(t){if(!this.baseUrl)return t;const r=this.__effectiveBaseUrl,o=t.startsWith("/")?new URL(r).origin+t:`./${t}`,i=new URL(o,r).href;if(i.startsWith(r))return i.slice(r.length)}addRoutes(t){return this.#t.__children=[...this.#t.__children??[],...Kt(t)],this.getRoutes()}}var Ir=$i;function Fr(e,t,r,o){const i=t.name??o?.(t);if(i&&(e.has(i)?e.get(i)?.push(t):e.set(i,[t])),Array.isArray(r))for(const a of r)a.parent=t,Fr(e,a,a.__children??a.children,o)}function er(e,t){const r=e.get(t);if(r){if(r.length>1)throw new Error(`Duplicate route with name "${t}". Try seting unique 'name' route properties.`);return r[0]}}function Ei(e,t={}){if(!(e instanceof Ir))throw new TypeError("An instance of Resolver is expected");const r=new Map,o=new Map;return(i,a)=>{let n=er(o,i);if(!n&&(o.clear(),Fr(o,e.root,e.root.__children,t.cacheKeyProvider),n=er(o,i),!n))throw new Error(`Route "${i}" not found`);let s=n.fullPath?r.get(n.fullPath):void 0;if(!s){let u=Gt(n),c=n.parent;for(;c;){const b=Gt(c);b&&(u=`${b.replace(/\/$/u,"")}/${u.replace(/^\//u,"")}`),c=c.parent}const m=Pe(u),f=Object.create(null);for(const b of m)N(b)||(f[b.name]=!0);s={keys:f,tokens:m},r.set(u,s),n.fullPath=u}let d=Or(s.tokens,{encode:encodeURIComponent,...t})(a)||"/";if(t.stringifyQueryParams&&a){const u={};for(const[m,f]of Object.entries(a))!(m in s.keys)&&f&&(u[m]=f);const c=t.stringifyQueryParams(u);c&&(d+=c.startsWith("?")?c:`?${c}`)}return d}}var Ai=Ei;const Ci=/\/\*[\*!]\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,jt=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function zi(){function e(){return!0}return Nr(e)}function Si(){try{return Pi()?!0:Di()?jt?!Oi():!zi():!1}catch{return!1}}function Pi(){return localStorage.getItem("vaadin.developmentmode.force")}function Di(){return["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0}function Oi(){return!!(jt&&Object.keys(jt).map(t=>jt[t]).filter(t=>t.productionMode).length>0)}function Nr(e,t){if(typeof e!="function")return;const r=Ci.exec(e.toString());if(r)try{e=new Function(r[1])}catch(o){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",o)}return e(t)}window.Vaadin=window.Vaadin||{};const rr=function(e,t){if(window.Vaadin.developmentMode)return Nr(e,t)};window.Vaadin.developmentMode===void 0&&(window.Vaadin.developmentMode=Si());function Ti(){/*! vaadin-dev-mode:start
  (function () {
'use strict';
...
`;var Ji=Object.defineProperty,Qi=Object.getOwnPropertyDescriptor,Br=(e,t,r,o)=>{for(var i=o>1?void 0:o?Qi(t,r):t,a=e.length-1,n;a>=0;a--)(n=e[a])&&(i=(o?n(t,r,i):n(i))||i);return o&&i&&Ji(t,r,i),i};let Yt=class extends D{constructor(){super(),this.deferredPrompt=null,window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),this.deferredPrompt=e}),window.addEventListener("appinstalled",()=>{this.deferredPrompt=null})}connectedCallback(){super.connectedCallback();const e=new CustomEvent("change-title",{detail:{title:"Strona Główna"},bubbles:!0,composed:!0});this.dispatchEvent(e)}async installApp(){if(!this.deferredPrompt)return;this.deferredPrompt.prompt();const{outcome:e}=await this.deferredPrompt.userChoice;e==="accepted"&&(this.deferredPrompt=null)}handleNavigation(e){const r="/mParafia/"+e.substring(1);window.history.pushState({},"",r),window.dispatchEvent(new PopStateEvent("popstate"))}render(){return g`
      <main>
    ...
    `];Br([C()],Yt.prototype,"deferredPrompt",2);Yt=Br([at("app-home")],Yt);var ta=x`
  :host {
    display: inline-block;
  }
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const oa=_r(class extends xr{constructor(e){if(super(e),e.type!==J.PROPERTY&&e.type!==J.ATTRIBUTE&&e.type!==J.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!No(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===L||t===_)return t;const r=e.element,o=e.name;if(e.type===J.PROPERTY){if(t===r[o])return L}else if(e.type===J.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return L}else if(e.type===J.ATTRIBUTE&&r.getAttribute(o)===t+"")return L;return jo(e),t}});var $=class extends O{constructor(){super(...arguments),this.formControlController=new Pr(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new Ee(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(){this.checked=!this.checked,this.emit("sl-change")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleKeyDown(e){e.key==="ArrowLeft"&&(e.preventDefault(),this.checked=!1,this.emit("sl-change"),this.emit("sl-input")),e.key==="ArrowRight"&&(e.preventDefault(),this.checked=!0,this.emit("sl-change"),this.emit("sl-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return g`
      <div
...
`,Rt=class extends O{constructor(){super(...arguments),this.disableRole=!1,this.label=""}handleFocus(e){const t=Et(e.target);t?.toggleAttribute("data-sl-button-group__button--focus",!0)}handleBlur(e){const t=Et(e.target);t?.toggleAttribute("data-sl-button-group__button--focus",!1)}handleMouseOver(e){const t=Et(e.target);t?.toggleAttribute("data-sl-button-group__button--hover",!0)}handleMouseOut(e){const t=Et(e.target);t?.toggleAttribute("data-sl-button-group__button--hover",!1)}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(t=>{const r=e.indexOf(t),o=Et(t);o&&(o.toggleAttribute("data-sl-button-group__button",!0),o.toggleAttribute("data-sl-button-group__button--first",r===0),o.toggleAttribute("data-sl-button-group__button--inner",r>0&&r<e.length-1),o.toggleAttribute("data-sl-button-group__button--last",r===e.length-1),o.toggleAttribute("data-sl-button-group__button--radio",o.tagName.toLowerCase()==="sl-radio-button"))})}render(){return g`
    ...
    `}renderMonthView(){const e=this.currentDate.getFullYear(),t=this.currentDate.getMonth(),r=new Date(e,t+1,0).getDate(),o=Array.from({length:r},(s,l)=>l+1),i=new Date(e,t,1).getDay(),a=i===0?6:i-1,n=Array.from({length:a},(s,l)=>l);return g`
      <div class="grid-month">
        ${["Pn","Wt","Śr","Cz","Pt","Sb","Nd"].map(s=>g`<div class="day-name">${s}</div>`)}
        ${n.map(()=>g`<div class="day empty"></div>`)}
        ${o.map(s=>{const l=this._formatDateString(new Date(e,t,s)),d=this.getFilteredEvents().filter(c=>c.date===l),u=this._isToday(new Date(e,t,s));return g`
            <div
    ...
    `}renderWeekView(){const e=this._getStartOfWeek(this.currentDate),t=Array.from({length:7},(r,o)=>{const i=new Date(e);return i.setDate(i.getDate()+o),i});return g`
      <div class="grid-week">
        ${t.map(r=>{const o=this._formatDateString(r),i=this.getFilteredEvents().filter(n=>n.date===o),a=this._isToday(r);return g`
            <div
            ...
            >
              ...
              ${i.length>0?this.renderEventTags(i,"week"):g`<div class="no-events-small">Brak</div>`}
            </div>
          `})}
      </div>
    `}renderDayView(){const e=this._formatDateString(this.currentDate),t=this.getFilteredEvents().filter(o=>o.date===e),r=this._isToday(this.currentDate);return g`
      <div class="list-view">
        <div class=${H({"list-day-row":!0,today:r})}>
          <div class="list-day-header">Wydarzenia</div>

          ${t.length>0?this.renderEventTags(t,"day"):g`<span class="no-events" style="display:block; padding: 20px 0; font-size: 0.85rem; color: #666; text-align: center; font-style: italic;">Brak wydarzeń zaplanowanych na ten dzień.</span>`}
        </div>
      </div>
    `}renderEventTags(e,t){const r=t==="week"||t==="day",o=t==="day";return e.map(i=>g`
      <calendar-item
        time="${i.time}"
        name="${i.title}"
        category="${i.category}"
 ...
 /* --- STYLE PRZEŁĄCZNIKA (FILTROWANIA) --- */
    ...
    `];Lt([C()],it.prototype,"events",2);Lt([C()],it.prototype,"currentView",2);Lt([C()],it.prototype,"currentDate",2);Lt([C()],it.prototype,"showOnlyMyGroups",2);it=Lt([at("app-calendar")],it);var ca=Object.defineProperty,da=Object.getOwnPropertyDescriptor,Wr=(e,t,r,o)=>{for(var i=o>1?void 0:o?da(t,r):t,a=e.length-1,n;a>=0;a--)(n=e[a])&&(i=(o?n(t,r,i):n(i))||i);return o&&i&&ca(t,r,i),i};let Zt=class extends D{constructor(){super(...arguments),this.groups=[{id:"domowy",name:"Domowy Kościół",photoUrl:"dk_small.jpg"},{id:"lso",name:"Liturgiczna Służba Ołtarza",photoUrl:"lso_small.jpg"},{id:"schola",name:'Schola "Aniołki Królowej"',photoUrl:"schola_small.jpg"},{id:"biblijna",name:"Grupa biblijna",photoUrl:"biblijna_small.jpg"},{id:"oaza",name:"Oaza",photoUrl:"oaza_small.png"},{id:"rada",name:"Rada Parafialna",photoUrl:"rada_small.png"},{id:"odb",name:"Oaza Dzieci Bożych",photoUrl:"odb_small.png"}]}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent("change-title",{detail:{title:"Grupy Parafialne"},bubbles:!0,composed:!0}))}render(){return g`
    ...
    `];qr([C()],Xt.prototype,"events",2);Xt=qr([at("app-events")],Xt);var pa=Object.getOwnPropertyDescriptor,fa=(e,t,r,o)=>{for(var i=o>1?void 0:o?pa(t,r):t,a=e.length-1,n;a>=0;a--)(n=e[a])&&(i=n(i)||i);return i};let me=class extends D{connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent("change-title",{detail:{title:"Strona w przygotowaniu"},bubbles:!0,composed:!0}))}_navHome(){window.history.pushState({},"","/mParafia/"),window.dispatchEvent(new PopStateEvent("popstate"))}render(){return g`
    ...
    `}};me.styles=[nt,x`
      ...
      /* --- ELIMINACJA NIEBIESKIEGO NA NAJECHANIU --- */

      /* Dla ciemnego przycisku - tylko lekkie rozjaśnienie */
...
//# sourceMappingURL=index-Dy6TTG09.js.map
