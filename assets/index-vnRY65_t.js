...
`,Nt,O=class extends L{constructor(){super(),Oo(this,Nt,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){const r=new CustomEvent(e,ht({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(r),r}static define(e,t=this,r={}){const o=customElements.get(e);if(!o){try{customElements.define(e,t,r)}catch{customElements.define(e,class extends t{},r)}return}let i=" (unknown version)",n=i;"version"in t&&t.version&&(i=" v"+t.version),"version"in o&&o.version&&(n=" v"+o.version),!(i&&n&&i===n)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${n} has already been registered.`)}attributeChangedCallback(e,t,r){Po(this,Nt)||(this.constructor.elementProperties.forEach((o,i)=>{o.reflect&&this[i]!=null&&this.initialReflectedProperties.set(i,this[i])}),Do(this,Nt,!0)),super.attributeChangedCallback(e,t,r)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,r)=>{e.has(r)&&this[r]==null&&(this[r]=t)})}};Nt=new WeakMap;O.version="2.20.1";O.dependencies={};h([p()],O.prototype,"dir",2);h([p()],O.prototype,"lang",2);/**
 * @license
 ...
 */const $r=Symbol.for(""),Zo=e=>{if(e?.r===$r)return e?._$litStatic$},qt=(e,...t)=>({_$litStatic$:t.reduce((r,o,i)=>r+(n=>{if(n._$litStatic$!==void 0)return n._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${n}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(o)+e[i+1],e[0]),r:$r}),Ye=new Map,Xo=e=>(t,...r)=>{const o=r.length;let i,n;const a=[],s=[];let l,d=0,u=!1;for(;d<o;){for(l=t[d];d<o&&(n=r[d],(i=Zo(n))!==void 0);)l+=i+t[++d],u=!0;d!==o&&s.push(n),a.push(l),d++}if(d===o&&a.push(t[o]),u){const c=a.join("$$lit$$");(t=Ye.get(c))===void 0&&(a.raw=a,Ye.set(c,t=a)),r=s}return e(t,...r)},Vt=Xo(v);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
//# sourceMappingURL=index-vnRY65_t.js.map
