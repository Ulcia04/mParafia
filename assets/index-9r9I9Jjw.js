...
`,g=class extends O{constructor(){super(...arguments),this.formControlController=new Qo(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new yr(this,"[default]","prefix","suffix"),this.localize=new Ee(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Ae}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink(),t=e?Ht`a`:Ht`button`;return Ut`
    ...
    `}};g.styles=[Q,ti];g.dependencies={"sl-icon":R,"sl-spinner":Er};h([X(".button")],g.prototype,"button",2);h([F()],g.prototype,"hasFocus",2);h([F()],g.prototype,"invalid",2);h([p()],g.prototype,"title",2);h([p({reflect:!0})],g.prototype,"variant",2);h([p({reflect:!0})],g.prototype,"size",2);h([p({type:Boolean,reflect:!0})],g.prototype,"caret",2);h([p({type:Boolean,reflect:!0})],g.prototype,"disabled",2);h([p({type:Boolean,reflect:!0})],g.prototype,"loading",2);h([p({type:Boolean,reflect:!0})],g.prototype,"outline",2);h([p({type:Boolean,reflect:!0})],g.prototype,"pill",2);h([p({type:Boolean,reflect:!0})],g.prototype,"circle",2);h([p()],g.prototype,"type",2);h([p()],g.prototype,"name",2);h([p()],g.prototype,"value",2);h([p()],g.prototype,"href",2);h([p()],g.prototype,"target",2);h([p()],g.prototype,"rel",2);h([p()],g.prototype,"download",2);h([p()],g.prototype,"form",2);h([p({attribute:"formaction"})],g.prototype,"formAction",2);h([p({attribute:"formenctype"})],g.prototype,"formEnctype",2);h([p({attribute:"formmethod"})],g.prototype,"formMethod",2);h([p({attribute:"formnovalidate",type:Boolean})],g.prototype,"formNoValidate",2);h([p({attribute:"formtarget"})],g.prototype,"formTarget",2);h([ct("disabled",{waitUntilFirstUpdate:!0})],g.prototype,"handleDisabledChange",1);g.define("sl-button");var ei=A`
  :host {
...
`,Dt=class extends O{constructor(){super(...arguments),this.disableRole=!1,this.label=""}handleFocus(e){const t=$t(e.target);t?.toggleAttribute("data-sl-button-group__button--focus",!0)}handleBlur(e){const t=$t(e.target);t?.toggleAttribute("data-sl-button-group__button--focus",!1)}handleMouseOver(e){const t=$t(e.target);t?.toggleAttribute("data-sl-button-group__button--hover",!0)}handleMouseOut(e){const t=$t(e.target);t?.toggleAttribute("data-sl-button-group__button--hover",!1)}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(t=>{const r=e.indexOf(t),o=$t(t);o&&(o.toggleAttribute("data-sl-button-group__button",!0),o.toggleAttribute("data-sl-button-group__button--first",r===0),o.toggleAttribute("data-sl-button-group__button--inner",r>0&&r<e.length-1),o.toggleAttribute("data-sl-button-group__button--last",r===e.length-1),o.toggleAttribute("data-sl-button-group__button--radio",o.tagName.toLowerCase()==="sl-radio-button"))})}render(){return v`
    ...
    `}};Dt.styles=[Q,qi];h([X("slot")],Dt.prototype,"defaultSlot",2);h([F()],Dt.prototype,"disableRole",2);h([p()],Dt.prototype,"label",2);function $t(e){var t;const r="sl-button, sl-radio-button";return(t=e.closest(r))!=null?t:e.querySelector(r)}Dt.define("sl-button-group");var Ki=Object.defineProperty,Gi=Object.getOwnPropertyDescriptor,ut=(e,t,r,o)=>{for(var i=o>1?void 0:o?Gi(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(i=(o?a(t,r,i):a(i))||i);return o&&i&&Ki(t,r,i),i};let H=class extends D{constructor(){super(...arguments),this.time="",this.name="",this.targetUrl="",this.category="wydarzenie",this.multiline=!1}handleClick(){if(!this.targetUrl)return;const t="/mParafia/"+this.targetUrl.substring(1);window.history.pushState({},"",t),window.dispatchEvent(new PopStateEvent("popstate"))}render(){const e=this.category==="wydarzenie";return v`
    ...
    `];Zt([F()],at.prototype,"events",2);Zt([F()],at.prototype,"currentView",2);Zt([F()],at.prototype,"currentDate",2);at=Zt([st("app-calendar")],at);var Xi=Object.getOwnPropertyDescriptor,Qi=(e,t,r,o)=>{for(var i=o>1?void 0:o?Xi(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(i=a(i)||i);return i};let ue=class extends D{connectedCallback(){super.connectedCallback();const t=new CustomEvent("change-title",{detail:{title:"Grupy"},bubbles:!0,composed:!0});this.dispatchEvent(t)}render(){return v`
      <div>
        <!-- wnętrze podstrony -->
      </div>
    `}};ue.styles=[dt,A`
...
//# sourceMappingURL=index-9r9I9Jjw.js.map
